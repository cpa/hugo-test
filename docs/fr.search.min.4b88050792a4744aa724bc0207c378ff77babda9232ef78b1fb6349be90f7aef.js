...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/hugo-test/flexsearch.min.js');loadScript('/hugo-test/fr.search-data.min.7bf86cbff7025105d1920622dc9a7456cba591281ece4d94034d0a93fbf00a75.js',function(){input.required=false;search();});}
